...
const Middle = () => {
    ...
    const description = 
    `A Passionate Frontend Developer having experience of building web application with JavaScript, Reactjs, Nodejs and some other cool libraries and frameworks with JS. Contact me through my social sites and query about the services. Thank you`
    // const description = 
    ...
    return ( 
            <div className={`${classes.middle_wrapper} grid grid-auto md:grid-cols-2 pb-2`} >
                <div className="text-white flex flex-col space-y-5 items-start pt-9">
                    ...
                    <button type='button' onClick={resume} className='capitalize btn bg-primary hover:bg-gray-500 py-2 px-4 rounded drop-shadow-md flex items-center'>
                            <svg className='inline mr-2' width="20" height="27" viewBox="0 0 20 27" fill="none" xmlns="http://www.w3.org/2000/svg">
